        ...
        <div class="vi-wcaio-sidebar-cart-footer-wrap">
			...
			if ( $is_customize || $sidebar_cart::$settings->get_params( 'sc_header_coupon_enable' ) ) {
				if ($last_applied_coupon){
					...
					$last_applied_coupon_t= esc_attr__( '[:en]Promo code[:ua]Промокод[:ru]Промокод[:]', 'woo-cart-all-in-one' );
				}
				?>
                <div class="vi-wcaio-sidebar-cart-header-coupon-wrap">
                    ...
                    <button type="submit" class="button vi-wcaio-bt-coupon-code" name="apply_coupon">
						<?php echo sprintf( '%s', apply_filters( 'vi_wcaio_get_bt_coupon_text', esc_html__( '[:en]Apply[:ua]Застосувати[:ru]Применить[:]', 'woo-cart-all-in-one' ) ) ); ?>
                    </button>
                </div>
				<?php
			}
				...
				if ( $is_customize ) {
                    ...
                    <div class="vi-wcaio-sidebar-cart-footer-action">
                        <button class="vi-wcaio-sidebar-cart-bt vi-wcaio-sidebar-cart-bt-update button">
							<?php echo wp_kses_post( apply_filters( 'vi_wcaio_get_bt_update_text', esc_html__( '[:en]Update Cart[:ua]Оновити кошик[:ru]Обновить корзину[:]', 'woo-cart-all-in-one' ) ) ); ?>
                        </button>
                        ...
                        <a href="#" data-href="<?php echo esc_attr( esc_url( get_permalink( wc_get_page_id( 'checkout' ) ) ) ); ?>"
                           class="button vi-wcaio-sidebar-cart-bt vi-wcaio-sidebar-cart-bt-nav vi-wcaio-sidebar-cart-bt-nav-checkout<?php echo esc_attr($sc_footer_button === 'checkout' ? '' :  ' vi-wcaio-disabled' ); ?>">
                            ...
                            <img class="notd-checkout-icon-side-cart" src="<?php echo plugins_url( 'woo-cart-all-in-one/assets/images/checkout-icon.png'); ?>">
            ...
            <div class="vi-wcaio-sidebar-cart-footer-message-wrap"> <!--class="product-slider"-->
